...
# --- Priority blending (light touch) ---
        ...
        expert_rows.append({
            ...
            "LadderScale": ind.get("LadderScale"), "TrailActive": ind.get("TrailActive"), "TrailStop": ind.get("TrailStop"), "TrailMult": ind.get("TrailMult"), "TrailReason": ind.get("TrailReason"), "Earnings_Window_Flag": ind.get("Earnings_Window_Flag"), "RSI_OK": ind.get("RSI_OK"), "GapChase_OK": ind.get("GapChase_OK"), "Stoch_Long_OK": ind.get("Stoch_Long_OK"),
            "Earnings_Window_Flag": ind.get("Earnings_Window_Flag"),
            "RSI_OK": ind.get("RSI_OK"),
            "GapChase_OK": ind.get("GapChase_OK"),
            "Stoch_Long_OK": ind.get("Stoch_Long_OK"),
            "TrailActive": ind.get("TrailActive"),
            "TrailStop": ind.get("TrailStop"),
            "TrailMult": ind.get("TrailMult"),
            "TrailReason": ind.get("TrailReason"),
            "DataMode": DataMode, "AsOf": asof, "Session": session, "DelayMin": delay,
